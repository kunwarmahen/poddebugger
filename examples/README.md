...
Four reference examples for the most common ways to extend or experiment
with PodDebugger.
...
All four run with **no API key** in `--demo` mode — they stub the LLM or
the provider so you can see the wiring without spending tokens.
